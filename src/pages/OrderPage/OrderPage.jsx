...
const OrderPage = () => {
    ...
    const deliveryPrice = useMemo(() => {
        if (provisional >= 300000) {
            return 0
        } else if (provisional === 0) {
            return 0
        } else if (provisional >= 50000) {
            return 20000
        }
        else {
            return 30000
    ...
    const items = [
        {
            title: '30.000đ',
            description: 'dưới 50.000đ',
        },
        {
            title: '20.000đ',
            description: 'dưới 300.000đ',
            ...
            <Row justify="center" style={{ maxWidth: '1250px', margin: '0 auto' }}>
                ...
                <Col xs={24} md={17} style={{ background: '#fff', padding: '20px', marginRight: '20px', borderRadius: '8px' }}>
                    <Row style={{ marginBottom: '30px' }}>
                        <Step items={items} current={deliveryPrice === 30000 ? 1 : deliveryPrice === 20000 ? 2 : provisional >= 300000 ? 3 : 0} />
                    </Row>
                        ...
                        return <Row align="middle" style={{ padding: '15px 0', borderTop: '1px solid #f0f0f0' }}>
                            ...
                            <Col span={4}>
                                ...
                                <WrapperInputNumber readOnly
                                    style={{ width: '40px' }} min={1} max={100} defaultValue={1} onChange={handleChangeCount} value={order?.amount} />
